...
namespace BT
{
    ...
    /// </summary>
    public class TimerOver : DecoratorNode
    {
        float _successTime;
        float _timer = 0;
        ...
        public TimerOver(float successTime, BTNode content) : base(content)
        {
        ...
        /// <returns></returns>
        public TimerOver SetOption(bool successOnce = true, bool abortOnTimeOver = false)
        {
